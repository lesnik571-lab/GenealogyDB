...
| --- | --- | --- | ---: | --- | --- | --- |
| database.configured-availability | Database | WARNING | 0.000s | C:\Users\lesni\AppData\Local\Temp\pytest-of-lesnik\pytest-467\test_missing_configured_databa0\missing.db | Configured database does not exist; validation did not create it. | not applicable |
...
| startup.viewer-safety | Startup | WARNING | 0.201s | static AST scan | cleanup failed: locked | cleanup failed: locked |
...
| database.initialize | Database | WARNING | 0.220s | completed | cleanup failed: locked | cleanup failed: locked |
