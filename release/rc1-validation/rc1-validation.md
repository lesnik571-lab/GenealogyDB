...
| --- | --- | --- | ---: | --- | --- | --- |
| database.configured-availability | Database | WARNING | 0.000s | C:\Users\lesni\AppData\Local\Temp\pytest-of-lesnik\pytest-472\test_missing_configured_databa0\missing.db | Configured database does not exist; validation did not create it. | not applicable |
...
| database.initialize | Database | WARNING | 0.229s | completed | cleanup failed: locked | cleanup failed: locked |
| import.preview | Import | WARNING | 0.000s | completed | cleanup failed: locked | cleanup failed: locked |
| import.confirmed | Import | WARNING | 0.096s | completed | cleanup failed: locked | cleanup failed: locked |
