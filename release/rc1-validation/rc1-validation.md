...
| --- | --- | --- | ---: | --- | --- | --- |
| database.configured-availability | Database | WARNING | 0.000s | C:\Users\lesni\AppData\Local\Temp\pytest-of-lesnik\pytest-491\test_missing_configured_databa0\missing.db | Configured database does not exist; validation did not create it. | not applicable |
...
| database.initialize | Database | WARNING | 0.222s | completed | cleanup failed: locked | cleanup failed: locked |
...
| sources.citation | Sources | WARNING | 0.033s | completed | cleanup failed: locked | cleanup failed: locked |
...
| backup.restore | Backup/Restore | WARNING | 0.022s | completed | cleanup failed: locked | cleanup failed: locked |
