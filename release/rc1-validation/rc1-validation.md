...
| --- | --- | --- | ---: | --- | --- | --- |
| database.configured-availability | Database | WARNING | 0.000s | C:\Users\lesni\AppData\Local\Temp\pytest-of-lesnik\pytest-478\test_missing_configured_databa0\missing.db | Configured database does not exist; validation did not create it. | not applicable |
...
| startup.viewer-safety | Startup | WARNING | 0.207s | static AST scan | cleanup failed: locked | cleanup failed: locked |
...
| database.initialize | Database | WARNING | 0.226s | completed | cleanup failed: locked | cleanup failed: locked |
| import.preview | Import | WARNING | 0.000s | completed | cleanup failed: locked | cleanup failed: locked |
| import.confirmed | Import | WARNING | 0.093s | completed | cleanup failed: locked | cleanup failed: locked |
...
| crud.event | CRUD | WARNING | 0.009s | completed | cleanup failed: locked | cleanup failed: locked |
...
| undo-redo.person | Undo/Redo | WARNING | 0.041s | completed | cleanup failed: locked | cleanup failed: locked |
| analysis.validation | Analysis | WARNING | 0.003s | validation report produced | cleanup failed: locked | cleanup failed: locked |
