...
| --- | --- | --- | --- | --- |
| viewer.interactions | Menus, toolbar buttons, and keyboard shortcuts | PASS | 349 command targets checked |  |
...
| viewer.exports | Export entries have handlers | PASS | 46 export handlers; 39 save dialogs |  |
| viewer.dialog-titles | Dialog titles are non-empty | PASS | 62 title calls |  |
| viewer.russian-labels | Russian labels are valid Unicode | PASS | 1531 Russian labels checked |  |
