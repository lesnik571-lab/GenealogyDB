...
| --- | --- | --- | --- | --- |
| viewer.interactions | Menus, toolbar buttons, and keyboard shortcuts | PASS | 345 command targets checked |  |
...
| viewer.dialog-titles | Dialog titles are non-empty | PASS | 58 title calls |  |
