...
| --- | --- | --- | --- | --- |
| viewer.interactions | Menus, toolbar buttons, and keyboard shortcuts | PASS | 351 command targets checked |  |
| viewer.help | Help entries have commands | PASS | entries: User Manual, Release Center, Beta Readiness, RC1 Validation, 2.1 Integration Check, Diagnostics, About |  |
| viewer.exports | Export entries have handlers | PASS | 46 export handlers; 40 save dialogs |  |
| viewer.dialog-titles | Dialog titles are non-empty | PASS | 64 title calls |  |
| viewer.russian-labels | Russian labels are valid Unicode | PASS | 1548 Russian labels checked |  |
