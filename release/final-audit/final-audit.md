...
| --- | --- | --- | --- | --- |
| viewer.interactions | Menus, toolbar buttons, and keyboard shortcuts | PASS | 350 command targets checked |  |
...
| viewer.dialog-titles | Dialog titles are non-empty | PASS | 63 title calls |  |
