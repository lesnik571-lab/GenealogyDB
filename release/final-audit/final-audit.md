...
| --- | --- | --- | --- | --- |
| viewer.interactions | Menus, toolbar buttons, and keyboard shortcuts | PASS | 344 command targets checked |  |
...
| viewer.exports | Export entries have handlers | PASS | 46 export handlers; 37 save dialogs |  |
| viewer.dialog-titles | Dialog titles are non-empty | PASS | 57 title calls |  |
...
| viewer.services | Services instantiate once and remain registered | PASS | 28 startup services |  |
